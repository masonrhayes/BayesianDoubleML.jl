...
# ╔═╡ 33683fcc-4fe1-4300-a9a5-2e8c369d66c4
Pkg.add("Turing")
...
However, VI is an extremely good approximation in a variety of real-world scenarios; let's try a case where e.g., n=$(n2), p = $(p2).
